...
A integração com TON é opcional.
Serve apenas para:
- ligação externa
- doações voluntárias
- NFTs simbólicos
...
Os NFTs HUMAN são registos simbólicos.
Não oferecem benefícios futuros.
Não garantem acesso.
Não prometem retorno.

Existem como memória.

---

## 5. Ética

HUMAN compromete-se a:
- não explorar atenção
- não gamificar ansiedade
- não criar dependência artificial

O crescimento é lento por design.
